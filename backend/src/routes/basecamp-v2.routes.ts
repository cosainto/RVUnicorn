...
function serializeFeedItem(item: RawFeedItem, enrichment?: EnrichmentData) {
  return {
    ...
    rigPhoto: item.payload.rigPhoto || null,
    photos: item.payload.photos || null,
    postType: item.payload.postType || null,
          ...
          where: {
            ...
            NOT: {
              OR: [
                ...
                { name: { contains: 'Boat Access', mode: 'insensitive' } },
                { name: { contains: 'Boat Ramp', mode: 'insensitive' } },
                { name: { contains: 'Boat Launch', mode: 'insensitive' } },
                { name: { contains: 'Parking Lot', mode: 'insensitive' } },
                { name: { contains: 'Ranger Station', mode: 'insensitive' } },
              ],
            },
          },
