...
const FRONTEND_URL = process.env.FRONTEND_URL || 'https://www.rvunicorn.com';
...
if (process.env.GOOGLE_CLIENT_ID && process.env.GOOGLE_CLIENT_SECRET) {
  passport.use(new GoogleStrategy({
    ...
    callbackURL: `${process.env.BACKEND_URL || 'https://rvunicorn-production.up.railway.app'}/auth/google/callback`,
...
if (process.env.FACEBOOK_APP_ID && process.env.FACEBOOK_APP_SECRET) {
  passport.use(new FacebookStrategy({
    ...
    callbackURL: `${process.env.BACKEND_URL || 'https://rvunicorn-production.up.railway.app'}/auth/facebook/callback`,
