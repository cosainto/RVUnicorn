...
import { Edit2, Check, X, Home, Tent, MapPin, MoreHorizontal } from 'lucide-react';
...
{/* Edit Status */}
        <div className="flex flex-col gap-2">
          ...
          {/* Menu appears BELOW the input, completely separate */}
          {showMenu && (
            <div className="bg-white border border-gray-200 rounded-lg shadow-lg p-2 w-[200px]">
              <button
                onClick={() => {
                  handleEnableAutoStatus();
                  setShowMenu(false);
                }}
